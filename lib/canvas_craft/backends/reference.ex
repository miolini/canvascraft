defmodule CanvasCraft.Backends.Reference do
  @moduledoc """
  Minimal in-memory reference backend to validate the renderer behaviour contract and allow examples to run without the Skia NIF.

  Produces deterministic WEBP/PNG-like binaries (mocked) and accepts drawing calls as no-ops.
  """
